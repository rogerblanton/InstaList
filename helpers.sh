...
run-db-and-socket{
  docker run -dt -v '/home/ubuntu/InstaList:/usr/src/app' -p 8080:8080 -p 28015:28015 -p 29015:29015 --name rethinkdb rethinkdb;
  docker run -dt -v /home/ubuntu/InstaList:/usr/src/app --name socket -p 8181:8181/tcp -p 8181:8181/udp --link rethinkdb:rethinkdb  socket;
}
